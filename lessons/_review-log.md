...
- **4 broken links**, all from `4dacbe9` (2026-08-30) renaming `rules/how-we-work/` →
...
Harvested **1 rule**: `rules/how-we-work/strict-first-then-the-residual.md`.
