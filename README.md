...
| [how-we-work](rules/how-we-work/) | [Write in fragments, not sentences](rules/how-we-work/write-in-fragments-not-sentences.md) | One instruction given three times — "answer in two lines", "can you not blabber", "forsake grammar" — each softer form read as shorter sentences rather than no sentences |
| [how-we-work](rules/how-we-work/) | [A rule states itself in one line](rules/how-we-work/a-rule-states-itself-in-one-line.md) | An adopted, pinned, quoted rule that still did not fire — 97 lines of ~90 URLs and no rule text; 9 of 93 rules had no statement a script could lift |
...
| [how-we-work](rules/how-we-work/) | [A version string cannot detect drift](rules/how-we-work/a-version-string-cannot-detect-drift.md) | `plugin update` reporting "already at the latest version (1.2.3)" on two machines two commits behind — three different commits all calling themselves 1.2.3 |
